...
public enum FfiConverterTypeFutOptHistoricalClient implements FfiConverter<FutOptHistoricalClient, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(FutOptHistoricalClient value) {
        return value.uniffiClonePointer();
    }

    @Override
    public FutOptHistoricalClient lift(Pointer value) {
        return new FutOptHistoricalClient(value);
    }

    @Override
    public FutOptHistoricalClient read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(FutOptHistoricalClient value) {
      return 8L;
    }

    @Override
    public void write(FutOptHistoricalClient value, ByteBuffer buf) {
