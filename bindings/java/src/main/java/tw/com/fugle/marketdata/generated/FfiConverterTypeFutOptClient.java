...
public enum FfiConverterTypeFutOptClient implements FfiConverter<FutOptClient, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(FutOptClient value) {
        return value.uniffiClonePointer();
    }

    @Override
    public FutOptClient lift(Pointer value) {
        return new FutOptClient(value);
    }

    @Override
    public FutOptClient read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(FutOptClient value) {
      return 8L;
    }

    @Override
    public void write(FutOptClient value, ByteBuffer buf) {
