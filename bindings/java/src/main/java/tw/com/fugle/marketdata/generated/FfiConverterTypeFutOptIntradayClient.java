...
public enum FfiConverterTypeFutOptIntradayClient implements FfiConverter<FutOptIntradayClient, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(FutOptIntradayClient value) {
        return value.uniffiClonePointer();
    }

    @Override
    public FutOptIntradayClient lift(Pointer value) {
        return new FutOptIntradayClient(value);
    }

    @Override
    public FutOptIntradayClient read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(FutOptIntradayClient value) {
      return 8L;
    }

    @Override
    public void write(FutOptIntradayClient value, ByteBuffer buf) {
