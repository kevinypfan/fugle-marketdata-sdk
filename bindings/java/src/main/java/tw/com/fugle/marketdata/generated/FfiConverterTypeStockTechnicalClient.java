...
public enum FfiConverterTypeStockTechnicalClient implements FfiConverter<StockTechnicalClient, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(StockTechnicalClient value) {
        return value.uniffiClonePointer();
    }

    @Override
    public StockTechnicalClient lift(Pointer value) {
        return new StockTechnicalClient(value);
    }

    @Override
    public StockTechnicalClient read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(StockTechnicalClient value) {
      return 8L;
    }

    @Override
    public void write(StockTechnicalClient value, ByteBuffer buf) {
