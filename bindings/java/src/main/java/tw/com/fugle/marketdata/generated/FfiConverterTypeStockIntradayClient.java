...
public enum FfiConverterTypeStockIntradayClient implements FfiConverter<StockIntradayClient, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(StockIntradayClient value) {
        return value.uniffiClonePointer();
    }

    @Override
    public StockIntradayClient lift(Pointer value) {
        return new StockIntradayClient(value);
    }

    @Override
    public StockIntradayClient read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(StockIntradayClient value) {
      return 8L;
    }

    @Override
    public void write(StockIntradayClient value, ByteBuffer buf) {
