...
public enum FfiConverterTypeStockCorporateActionsClient implements FfiConverter<StockCorporateActionsClient, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(StockCorporateActionsClient value) {
        return value.uniffiClonePointer();
    }

    @Override
    public StockCorporateActionsClient lift(Pointer value) {
        return new StockCorporateActionsClient(value);
    }

    @Override
    public StockCorporateActionsClient read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(StockCorporateActionsClient value) {
      return 8L;
    }

    @Override
    public void write(StockCorporateActionsClient value, ByteBuffer buf) {
