...
public enum FfiConverterTypeWebSocketClient implements FfiConverter<WebSocketClient, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(WebSocketClient value) {
        return value.uniffiClonePointer();
    }

    @Override
    public WebSocketClient lift(Pointer value) {
        return new WebSocketClient(value);
    }

    @Override
    public WebSocketClient read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(WebSocketClient value) {
      return 8L;
    }

    @Override
    public void write(WebSocketClient value, ByteBuffer buf) {
