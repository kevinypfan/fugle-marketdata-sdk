...
public enum FfiConverterTypeStockHistoricalClient implements FfiConverter<StockHistoricalClient, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(StockHistoricalClient value) {
        return value.uniffiClonePointer();
    }

    @Override
    public StockHistoricalClient lift(Pointer value) {
        return new StockHistoricalClient(value);
    }

    @Override
    public StockHistoricalClient read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(StockHistoricalClient value) {
      return 8L;
    }

    @Override
    public void write(StockHistoricalClient value, ByteBuffer buf) {
