...
public enum FfiConverterTypeRestClient implements FfiConverter<RestClient, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(RestClient value) {
        return value.uniffiClonePointer();
    }

    @Override
    public RestClient lift(Pointer value) {
        return new RestClient(value);
    }

    @Override
    public RestClient read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(RestClient value) {
      return 8L;
    }

    @Override
    public void write(RestClient value, ByteBuffer buf) {
