...
public enum FfiConverterTypeSnapshotQuote implements FfiConverterRustBuffer<SnapshotQuote> {
  INSTANCE;

  @Override
  public SnapshotQuote read(ByteBuffer buf) {
  ...
  @Override
  public long allocationSize(SnapshotQuote value) {
      return (
  ...
  @Override
  public void write(SnapshotQuote value, ByteBuffer buf) {
