...
public enum FfiConverterTypeStockClient implements FfiConverter<StockClient, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(StockClient value) {
        return value.uniffiClonePointer();
    }

    @Override
    public StockClient lift(Pointer value) {
        return new StockClient(value);
    }

    @Override
    public StockClient read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(StockClient value) {
      return 8L;
    }

    @Override
    public void write(StockClient value, ByteBuffer buf) {
