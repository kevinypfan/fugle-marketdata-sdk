...
public enum FfiConverterTypeStockSnapshotClient implements FfiConverter<StockSnapshotClient, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(StockSnapshotClient value) {
        return value.uniffiClonePointer();
    }

    @Override
    public StockSnapshotClient lift(Pointer value) {
        return new StockSnapshotClient(value);
    }

    @Override
    public StockSnapshotClient read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(StockSnapshotClient value) {
      return 8L;
    }

    @Override
    public void write(StockSnapshotClient value, ByteBuffer buf) {
