...
class TestRestClientAPICompatibility:
    ...
    def test_client_constructor_accepts_api_key(self):
        """Official: RestClient(api_key='api-key')"""
...
class TestOfficialSDKExamplePatterns:
    ...
    def test_rest_example_pattern(self):
        ...
        client = RestClient(api_key="mock-api-key")
    ...
    def test_websocket_example_pattern(self):
        ...
        """
        # Same constructor pattern
        ws = WebSocketClient(api_key="mock-api-key")
...
# |----------------------------------|--------------|---------------|----------------------|
# | **REST Client**                  |              |               |                      |
# | RestClient(api_key=api_key)              | sync         | sync          | Constructor          |
...
# |                                  |              |               |                      |
# | **WebSocket Client**             |              |               |                      |
# | WebSocketClient(api_key=api_key)         | sync         | sync          | Constructor          |
